...
<* endfor *>
  ...
  term4 = "{{ colors.primary_container.default.hex | auto_lightness: 40.0 }}",
  term5 = "{{ colors.primary.default.hex }}",
  term6 = "{{ colors.secondary_fixed_dim.default.hex | auto_lightness: 20.0 }}",
  term7 = "{{ colors.on_surface_variant.default.hex }}",
  term8 = "{{ colors.surface_bright.default.hex | auto_lightness: 20.0 }}",
  ...
  term12 = "{{ colors.primary_container.default.hex | auto_lightness: 15.0 }}",
  term13 = "{{ colors.primary.default.hex | auto_lightness: 8.0 }}",
  term14 = "{{ colors.secondary_fixed_dim.default.hex | auto_lightness: 8.0 }}",
